...
- Hai Hu*, Ziyin Zhang*, Weifang Huang, Jackie Yan-Ki Lai, Aini Li, Yina Patterson, Jiahui Huang, Peng Zhang, Chien-Jer Charles Lin, Rui Wang. (2023). Revisiting Acceptability Judgements: CoLAC - Corpus of Linguistic Acceptability in Chinese. *\*equal contributions*. [paper]([https://doi.org/10.1162/coli_a_00465](https://arxiv.org/abs/2305.14091)){:target="_blank"}. [data](https://github.com/huhailinguist/CoLAC/blob/main/README.md){:target="_blank"}. 

- Liu, Y., Zhang, Z., Zhang, W., Yue, S., Zhao, X., Cheng, X., Zhang, Y., & Hu, H. (2023). ArguGPT: evaluating, understanding and identifying argumentative essays generated by GPT models. ArXiv, abs/2304.07666.
